...
curl -sS https://istriku.me/gratis/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -q -O /usr/bin/badvpn-udpgw "https://istriku.me/gratis/ssh/newudpgw"
...
# install squid
cd
curl -sS "https://istriku.me/gratis/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://istriku.me/gratis/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://istriku.me/gratis/banner/issue.net"
