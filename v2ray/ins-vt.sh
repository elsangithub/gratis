...
wget -q -c "https://istriku.me/gratis/core/v2ray-core.sh" && chmod +x v2ray-core.sh && ./v2ray-core.sh >/dev/null 2>&1
rm -f v2ray-core.sh
sleep 1
echo -e "[ ${green}INFO$NC ] Downloading & Installing Trojan-Go"
wget -q -c "https://istriku.me/gratis/trojan/ins-trojango.sh" && chmod +x ins-trojango.sh && ./ins-trojango.sh >/dev/null 2>&1
...
wget -q -O /usr/bin/bbr "https://istriku.me/gratis/dll/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
