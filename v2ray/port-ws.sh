...
echo -e "\E[44;1;39m       ⇱ Change Port V2RAY ⇲       \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e ""
echo -e "   [1]  Change TLS $tls"
echo -e "   [2]  Change None TLS $none"
echo -e "   [x]  Exit"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e ""
...
read -p "New Port None TLS: " none1
if [ -z $none1 ]; then
echo "Please Input Port"
exit 0
fi
...
if [[ -z $cek ]]; then
sed -i "s/: $none/: $none1/g" /etc/v2ray/config.json
