...
read answer
    if [ "$answer" == "${answer#[Yy]}" ] ;then
        ...
        wget -q "https://istriku.me/gratis/dll/cf.sh" && chmod +x cf.sh && ./cf.sh
    fi
else
clear
...
wget -q "https://istriku.me/gratis/ssh/ssh-vpn.sh" && chmod +x ssh-vpn.sh && screen -S sshvpn ./ssh-vpn.sh
...
wget -q "https://istriku.me/gratis/wireguard/wg.sh" && chmod +x wg.sh && screen -S wg ./wg.sh
wget -q "https://istriku.me/gratis/sstp/sstp.sh" && chmod +x sstp.sh && screen -S sstp ./sstp.sh
wget -q "https://istriku.me/gratis/ipsec/ipsec.sh" && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget -q "https://istriku.me/gratis/shadowsocks/ss.sh" && chmod +x ss.sh && screen -S ss ./ss.sh
wget -q "https://istriku.me/gratis/shadowsocks/ssr.sh" && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget -q "https://istriku.me/gratis/dll/system/set-br.sh" && chmod +x set-br.sh && screen -S sbr ./set-br.sh
#extension
clear
sleep 1
