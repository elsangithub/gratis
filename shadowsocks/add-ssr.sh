...
echo -e "\E[44;1;39m          ⇱ SSR ACCOUNT ⇲          \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo -e "\E[44;1;39m          ⇱ SSR ACCOUNT ⇲          \E[0m" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo "" | tee -a /etc/log-create-user.log
echo -e " User ：${ssr_user}" | tee -a /etc/log-create-user.log
echo -e " IP : ${IP}" | tee -a /etc/log-create-user.log
echo -e " Port : ${ssr_port}" | tee -a /etc/log-create-user.log
echo -e " Password : ${ssr_password}" | tee -a /etc/log-create-user.log
echo -e " Encryption : ${ssr_method}" | tee -a /etc/log-create-user.log
echo -e " Protocol : ${Red_font_prefix}${ssr_protocol}" | tee -a /etc/log-create-user.log
echo -e " Obfs : ${Red_font_prefix}${ssr_obfs}" | tee -a /etc/log-create-user.log
echo -e " Device limit : ${ssr_protocol_param}" | tee -a /etc/log-create-user.log
echo -e " Expired On : ${exp} " | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo -e " Link SSR : ${ssr_link}" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo "" | tee -a /etc/log-create-user.log
read -n 1 -s -r -p "Press any key to back on menu"            
ss-menu