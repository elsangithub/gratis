...
wget -q --no-check-certificate https://istriku.me/gratis/core/ssr-core.sh -O /etc/init.d/ssrmu
...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://istriku.me/gratis/core/ssr-core.sh"
...
Install_SSR
systemctl restart ssrmu > /dev/null 2>&1
#wget -q -O /usr/bin/ssr istriku.me/gratis/shadowsocks/ssrmu.sh && chmod +x /usr/bin/ssr
